...
func request_UserService_GetUsersByIds_0(ctx context.Context, marshaler runtime.Marshaler, client UserServiceClient, req *http.Request, pathParams map[string]string) (UserService_GetUsersByIdsClient, runtime.ServerMetadata, error) {
	...
	stream, err := client.GetUsersByIds(ctx, &protoReq)
	if err != nil {
...
func RegisterUserServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UserServiceServer) error {
	...
	mux.Handle("POST", pattern_UserService_GetUsersByIds_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterUserServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UserServiceClient) error {
	...
	mux.Handle("POST", pattern_UserService_GetUsersByIds_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/user.UserService/GetUsersByIds", runtime.WithHTTPPathPattern("/user.UserService/GetUsersByIds"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		...
		forward_UserService_GetUsersByIds_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_UserService_GetUsersByIds_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"user.UserService", "GetUsersByIds"}, ""))
)

var (
	forward_UserService_GetUserById_0 = runtime.ForwardResponseMessage

	forward_UserService_GetUsersByIds_0 = runtime.ForwardResponseStream
)
